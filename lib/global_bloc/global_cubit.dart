...
class GlobalCubit extends Cubit<GlobalState> {
  ...
  String getCurrentTime() {
    ...
    // print(myTimeStamp.microsecondsSinceEpoch.toString());
    return myTimeStamp.microsecondsSinceEpoch.toString();
  }


  String getDate(String s){
    int num = int.parse(s);
    DateTime currentTime =DateTime.fromMicrosecondsSinceEpoch(num);
